<script setup lang="ts">
    ...
    import PhysicalActivity, { alias } from '../../models/PhysicalActivity';

    const route = useRoute();
    const { getPageByPatientId } = useActivity();
    const { page, error, totalPages, isPageLoading, onGetPage} = withReadOnlyControls<PhysicalActivity>(
        ...
        <v-row justify="center">
            <v-col>
                ...
                <v-card
                    ...
                    class="text-center"
                >
                    <v-card-title>Нет данных о физической активности этого пациента</v-card-title>
                </v-card>
            </v-col>
        </v-row>
    </v-container>
